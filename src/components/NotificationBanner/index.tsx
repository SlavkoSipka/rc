...
export function NotificationBanner() {
  ...
  const message = `⚡⚡⚡ IMPORTANT NOTICE...Our post office and customs has suspended export to USA due to the new import regulations and added taxes. We are monitoring this sitution and hope that this will be sortet quickly⚡⚡⚡` // OVDE PISES PORUKU
